...
public class WaveletNeighbor extends net.tinyos.message.Message {
    ...
    /** Create a new WaveletNeighbor of size 7. */
    ...
    /**
     * Create a new WaveletNeighbor with the given data_length
     * and base offset.
     */
    ...
    /**
     * Create a new WaveletNeighbor using the given byte array
     * as backing store.
     */
    ...
    /**
     * Create a new WaveletNeighbor embedded in the given message
     ...
     */
    public WaveletNeighbor(net.tinyos.message.Message msg, int base_offset, int data_length) {
    ...
    public float get_coeff() {
        return (float)getFloatElement(offsetBits_coeff(), 32);
    }
