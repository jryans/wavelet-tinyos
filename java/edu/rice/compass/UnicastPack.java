...
public class UnicastPack extends net.tinyos.message.Message {
    ...
    /** Create a new UnicastPack of size 27. */
    public UnicastPack() {
    ...
    /**
     * Return the value (as a short) of the field 'data.src'
     */
    public short get_data_src() {
        return (short)getSIntElement(offsetBits_data_src(), 16);
    }

    /**
     * Set the value of the field 'data.src'
     */
    public void set_data_src(short value) {
        setSIntElement(offsetBits_data_src(), 16, value);
    }
    ...
    /**
     * Return the value (as a short) of the field 'data.dest'
     */
    public short get_data_dest() {
        return (short)getSIntElement(offsetBits_data_dest(), 16);
    }

    /**
     * Set the value of the field 'data.dest'
     */
    public void set_data_dest(short value) {
        setSIntElement(offsetBits_data_dest(), 16, value);
    }
